...
@Component({
  selector: 'app-parametre-independant-form',
  templateUrl: './parametre-independant-form.component.html',
  styleUrls: ['./parametre-independant-form.component.scss'],
})
export class ParametreIndependantFormComponent implements OnInit, AfterViewInit {
